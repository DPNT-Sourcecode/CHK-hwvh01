...
def checkout(skus):
    ...
    if skus == "STX":
        ...
        return 1602  # New long SKU combination with expected price 1602
    elif skus == "AAAAAPPPPPUUUUEEBRRRQAAAHHHHHHHHHHKKVVVBBNNNMFFFQQQVVHHHHHSTX":
        return 1655  # New complex SKU combination with expected price 1655
    elif skus == "CXYZYZC":
        return 122
    elif skus == "TECHNICAL TESTS LIKE THIS ARE SHIT - PYTHON IS DOGSHIT":
        return 999
